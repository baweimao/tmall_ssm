...
<div class="boughtDiv">
	<div class="orderType">
		<div class="selectOrderType"><a orderStatus="all" href="#nowhere">所有订单</a></div>
		...
		<div class="orderTypeLastOne"><a class="noRightborder">&#12288</a></div>
	</div>
				...
				<c:forEach items="${o.orderItems}" var="oi" varStatus="st">
					<tr class="orderItemProductInfoPartTR">
						...
						<td class="orderItemProductInfoPartTD" width="100px">
							...
							<div class="orderListItemProductPrice">￥<fmt:formatNumber type="number" value="${oi.product.promotePrice}"/></div>
						</td>
						<c:if test="${st.count==1}">
							<td valign="top" rowspan="${fn:length(o.orderItems)}" class="orderListItemNumberTD orderItemOrderInfoPartTD">
							...
							<td valign="top" rowspan="${fn:length(o.orderItems)}" width="120px" class="orderListItemProductRealPriceTD orderItemOrderInfoPartTD">
								<div class="orderListItemProductRealPrice"><fmt:formatNumber type="number" value="${o.total}" minFractionDigits="2"/></div>
								<div class="orderListItemPriceWithTransport">(含运费：0)</div>
							</td>
