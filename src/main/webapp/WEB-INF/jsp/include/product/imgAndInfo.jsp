	...
	<div class="infoInimgAndInfo">
		...
		<div class="productPrice">
			<div class="juhuasuan">
				...
				<span>此商品即将参加聚划算，<span class="juhuasuanTime">1天19小时</span></span>
			</div>
		...
		<div class="buyDiv">
			...
			<a href="#nowhere" class="addCartLink"><button class="addCartButton"><span class="glyphicon glyphicon-shopping-cart"></span>加入购车</button></a>
		</div>	
	</div>
